...
const Navbar = () => {
  return (
    <nav className="flex bg-emerald-600 px-4 py-3 w-full">
      {/* <div>
        <img src={FotoPerfil1} className="rounded-full home-image w-20"/>
      </div> */}

      <div>
        <img src={ LOGOConNombre } alt="Foto del logo del movimiento" className="rounded-full w-3200 h-14 top-1/2"/>
      </div>
      ...
      <div className="w-full block flex-grow justify-center lg:flex lg:items-center lg:w-auto">
        ...
        <a
            ...
            className="block mt-4 lg:inline-block lg:mt-0 text-white text-lg hover:text-black mr-4 p-4"
          >
